...
/**
 * Created by omerjerk on 21/1/14.
 */
public class PlaceProvider extends ContentProvider {

    private static final String TAG = "PlaceProvider";

    public static final String AUTHORITY = "in.osc.carpool.utils.PlaceProvider";
    ...
    String mKey = "AIzaSyDLDO5X6RuJMkegssBCKipOSs8CTeEUCWY";
